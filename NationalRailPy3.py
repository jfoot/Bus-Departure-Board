...
parser.add_argument("-c","--HeaderAlignment", default="center", choices=['right','center'],help="If you use the 'loc' or 'date' header you can choose to either center or right align this text. By default it will center align.")
