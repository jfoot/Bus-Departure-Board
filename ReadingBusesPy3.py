...
def Splash():
	if Args.SplashScreen:
		with canvas(device) as draw:
			...
			draw.multiline_text((45, 35), "Version : 2.0.RB -  By Jonathan Foot", font=ImageFont.truetype("%s/resources/Skinny.ttf" % (os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))),15), align="center")
